...
\chapter{Recenzent \odgovor{--- ocena:} }
	...
	\begin{enumerate}
		...
		\odgovor{Smatram da je ispravno bez zareza}
		...
		\odgovor{Smatram da italik u ovom slučaju zamenjuje navodnike.}
...
GraalVM predstavlja JDK (eng \emph{Java Development Kit}) visokih performansi\cite{graalvm}. GraalVM omogućava ubrzanje izvršavanja uz korišćenje manje resursa. Java aplikacije je ovim moguće prevesi na dva načina: AOT(eng \emph{Ahead Of Time}) i JIT (eng. \emph{Just In Time}).
}
